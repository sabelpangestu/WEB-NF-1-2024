...
if (isset($_POST['submit'])) {
    ...
    //UPDATE Dokter SET nama = 'jono', gender = 'L', tmp_lahir = 'Bandung', tgl_lahir = '1980-05-15', kategori = 'Spesialis', telpon = 0832133, alamat = 'Depok', unit_kerja_id = 2 WHERE id = 1
    $stmt = $dbh->prepare($sql);
    $stmt->execute($data);
                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form action="/dokter/edit.php?id=<?= $row['id'] ?>" method="POST">
